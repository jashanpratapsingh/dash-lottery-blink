...
const RaffleLottery1: NextPage = () => {
  return (
    <div className="w-full relative bg-gray-400 h-[1200px] overflow-y-auto text-left text-mini text-white font-satoshi-variable">
      <div className="absolute bottom-[-125px] left-[calc(50%_-_1000px)] [filter:blur(80px)] rounded-[50%] [background:linear-gradient(90deg,_rgba(20,_241,_149,_0.8),_rgba(133,_236,_254,_0.8))] w-[2000px] h-[250px]" />
      <div className="absolute w-full top-[0px] right-[0px] left-[0px] h-[1200px]">
        <div className="absolute w-[calc(100%_-_64px)] top-[16px] right-[32px] left-[32px] h-[42px]">
          <b className="absolute top-[calc(50%_-_25px)] left-[-0.5px] text-17xl">
            DASH
          </b>
          <div className="absolute top-[calc(50%_-_21px)] left-[1549px] rounded-lg bg-whitesmoke-200 w-[111.2px] h-[42px] text-gray-100">
            <div className="absolute top-[11.5px] left-[16px] leading-[18px] font-medium flex items-center w-[82.6px] h-[18px]">
              Get started
            </div>
          </div>
          <div className="absolute top-[1px] left-[1676.2px] rounded-lg [background:linear-gradient(91.12deg,_#232324_4.07%,_#323335_50%,_#232324_95.93%)] w-[179.8px] h-10 overflow-hidden text-center">
            <img
              className="absolute top-[calc(50%_-_7px)] left-[calc(50%_-_65.9px)] w-3 h-3.5"
              alt=""
              src="/svg.svg"
            />
        ...
        <div className="absolute w-[calc(100%_-_64px)] top-[1150px] right-[32px] left-[32px] h-[34px] overflow-hidden hidden text-gray-100">
      ...
      <div className="absolute top-[139px] left-[calc(50%_-_350px)] rounded-11xl overflow-y-auto flex flex-col items-start justify-start p-[30px] gap-[30px] text-sm">
        <div className="flex flex-col items-center justify-start gap-[8px] text-silver-200">
          ...
          <div className="self-stretch flex flex-row items-start justify-center gap-[28px] text-center text-xs text-gray-900">
            <div className="rounded-8xs bg-gray-400 overflow-hidden flex flex-row items-start justify-start py-2.5 px-[18px] text-white border-[1px] border-solid border-border">
              <div className="relative leading-[14px]">All</div>
            </div>
            <div className="rounded-8xs bg-gray-400 overflow-hidden flex flex-row items-start justify-start py-2.5 px-[18px]">
              <div className="relative leading-[14px] font-medium">Loyalty</div>
            </div>
            <div className="rounded-8xs bg-gray-400 overflow-hidden flex flex-row items-start justify-start py-2.5 px-[18px]">
        ...
        <div className="w-[1100px] shadow-[3px_0px_10px_rgba(153,_69,_255,_0.4),_-3px_0px_10px_rgba(20,_241,_149,_0.4)] rounded-xl bg-gray-200 overflow-hidden shrink-0 flex flex-row items-start justify-start gap-[275px]">
          ...
          <div className="flex flex-col items-start justify-start py-5 px-12 gap-[20px]">
            <img
              ...
              src="/adidas-logo.svg"
            />
            <div className="self-stretch flex flex-row items-center justify-between text-purple">
              <div className="relative leading-[27.3px]">Adidas Airbender</div>
              <img
                className="w-[15px] relative h-[15px] overflow-hidden shrink-0"
                alt=""
                src="/fiexternallink.svg"
              />
            </div>
            <div className="w-[439px] relative text-xs leading-[27.3px] inline-block h-[55px] shrink-0">
              Enter a raffle to get the chance to win Adidas Airbenders.
            </div>
            <div className="w-[439px] flex flex-row items-start justify-between text-center">
              <div className="rounded-8xs bg-gray-200 box-border h-8 flex flex-row items-center justify-center py-2 px-0 border-[1px] border-solid border-border">
                <div className="w-[120px] relative leading-[32px] flex items-center justify-center shrink-0">
                  Buy Raffle
                </div>
              </div>
              <div className="rounded-8xs bg-gray-200 box-border h-8 flex flex-row items-center justify-center py-2 px-0 border-[1px] border-solid border-border">
              ...
              <div className="rounded-8xs bg-gray-200 box-border h-8 flex flex-row items-center justify-center py-2 px-0 border-[1px] border-solid border-border">
                <div className="self-stretch w-[120px] relative leading-[32px] flex items-center justify-center shrink-0">
                  View
                </div>
              </div>
            </div>
        ...
        <div className="w-[1100px] shadow-[3px_0px_10px_rgba(153,_69,_255,_0.4),_-3px_0px_10px_rgba(20,_241,_149,_0.4)] rounded-xl bg-gray-200 overflow-hidden shrink-0 flex flex-row items-start justify-start gap-[275px]">
          ...
          <div className="flex flex-col items-start justify-start py-5 px-12 gap-[20px]">
            ...
            <div className="w-[439px] relative text-xs leading-[27.3px] inline-block h-[55px] shrink-0">{`For all solana wallet holders, Jupiter is offering 10,000 $JUP upon swapping over 10 SOL monthly on Jupiter `}</div>
            <div className="w-[439px] flex flex-row items-start justify-between text-center">
              <div className="rounded-8xs bg-gray-200 box-border h-8 flex flex-row items-center justify-center py-2 px-0 border-[1px] border-solid border-border">
                <div className="w-[120px] relative leading-[32px] flex items-center justify-center shrink-0">
                  Mint Token
      ...
      <div className="absolute top-[139px] left-[20px] h-[203.4px] flex flex-col items-start justify-start gap-[23px] text-2xl text-whitesmoke-100">
        <div className="w-[424px] relative shadow-[3px_0px_10px_rgba(153,_69,_255,_0.4),_-3px_0px_10px_rgba(20,_241,_149,_0.4)] rounded-lg bg-black-grid box-border h-[200px] overflow-hidden shrink-0 opacity-[0.4] border-[1px] border-solid border-border-grey">
          ...
          <img
            className="absolute top-[22px] left-[24px] w-[51px] h-[51px] overflow-hidden"
            alt=""
            src="/gift-1.svg"
          />
        ...
        <div className="w-[424px] relative shadow-[3px_0px_10px_rgba(153,_69,_255,_0.4),_-3px_0px_10px_rgba(20,_241,_149,_0.4)] rounded-lg bg-black-grid box-border h-[200px] overflow-hidden shrink-0 text-lgi-8 border-[1px] border-solid border-border-grey">
          ...
          <div className="absolute h-[23.5%] w-[11.6%] top-[11%] right-[82.97%] bottom-[65.5%] left-[5.42%] text-white">
            <img
              className="absolute h-full w-[95.53%] top-[0%] right-[4.47%] bottom-[0%] left-[0%] rounded-[36.68px] max-w-full overflow-hidden max-h-full"
              alt=""
              src="/vector.svg"
            />
        ...
        <div className="w-[424px] relative shadow-[3px_0px_10px_rgba(153,_69,_255,_0.4),_-3px_0px_10px_rgba(20,_241,_149,_0.4)] rounded-lg bg-black-grid box-border h-[200px] overflow-hidden shrink-0 opacity-[0.4] border-[1px] border-solid border-border-grey">
          <div className="absolute top-[1px] left-[0.5px] rounded-lg bg-gray-1200 box-border w-[424px] h-[200px] overflow-hidden border-[1px] border-solid border-border-grey" />
          <img
            className="absolute top-[22.4px] left-[23.5px] w-[50px] h-[50px] overflow-hidden"
            alt=""
            src="/ustar.svg"
          />
