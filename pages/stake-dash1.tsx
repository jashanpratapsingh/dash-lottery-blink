...
const StakeDash1: NextPage = () => {
  return (
    <div className="w-full relative bg-gray-400 box-border h-[1200px] overflow-y-auto text-left text-2xl text-whitesmoke-100 font-satoshi-variable border-[1px] border-solid border-fills-quaternary">
      ...
      <div className="absolute top-[139px] left-[640px] w-[1060px] h-[1021.9px] text-xs text-white">
        <div className="absolute top-[0px] left-[0px] rounded-xl bg-gray-1100 w-[1060px] h-[1021.9px] overflow-hidden" />
        <img
          className="absolute h-[2.32%] w-[2.83%] top-[2.15%] right-[4.91%] bottom-[95.53%] left-[92.26%] max-w-full overflow-hidden max-h-full object-cover"
          alt=""
          src="/group-1@2x.png"
        />
        <div className="absolute top-[calc(50%_-_464.85px)] left-[calc(50%_-_414px)] bg-gray-800 w-[828.2px] h-[928.1px] flex flex-col items-center justify-center gap-[80px]">
          ...
          <div className="rounded flex flex-row items-start justify-center p-[5px] gap-[28px] text-center text-gray-900">
            <div className="w-[150px] rounded-8xs bg-gray-1100 box-border overflow-hidden shrink-0 flex flex-row items-start justify-center py-2.5 px-[18px] border-[1px] border-solid border-state-layers-on-primary-opacity-16">
              <div className="relative leading-[14px] font-medium">Stake</div>
            </div>
            <div className="w-[150px] rounded-8xs bg-gray-1100 box-border overflow-hidden shrink-0 flex flex-row items-start justify-center py-2.5 px-[18px] text-white border-[1px] border-solid border-border">
              <div className="relative leading-[14px]">Unstake</div>
            </div>
